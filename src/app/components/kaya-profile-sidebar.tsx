import { X, Mail, Phone, User, Home, Heart, Eye, LogOut } from "lucide-react";
...
export function KayaProfileSidebar({
  isOpen,
  onClose,
  userData,
  onLogout,
      ...
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-sm bg-white shadow-2xl z-50 overflow-y-auto">
        <div className="p-6">
          ...
          <div className="bg-gradient-to-br from-primary to-secondary rounded-2xl p-6 text-white mb-6">
            ...
            <h3 className="text-center text-xl mb-1">{userData.name}</h3>
            <p className="text-center text-green-100 text-sm">House Hunter</p>
          </div>

          {/* Contact Details */}
          <div className="bg-muted rounded-2xl p-5 mb-6">
            <h3 className="text-sm text-muted-foreground mb-4">Contact Information</h3>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-foreground truncate">{userData.email}</div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            <div className="bg-muted rounded-xl p-4 text-center">
              ...
              <div className="text-lg text-foreground mb-1">24</div>
            ...
            <div className="bg-muted rounded-xl p-4 text-center">
              ...
              <div className="text-lg text-foreground mb-1">8</div>
            ...
            <div className="bg-muted rounded-xl p-4 text-center">
              ...
              <div className="text-lg text-foreground mb-1">3</div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 bg-muted rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm text-foreground">Unlocked contact</div>
                  <div className="text-xs text-muted-foreground">Mamboleo Apartment</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-muted rounded-xl">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm text-foreground">Saved property</div>
                  <div className="text-xs text-muted-foreground">Milimani Studio</div>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Actions */}
          <div className="space-y-3">
            <button className="w-full flex items-center justify-between p-4 bg-muted rounded-xl hover:bg-muted-foreground/10 transition-colors">
              <div className="flex items-center gap-3">
            ...
            <button className="w-full flex items-center justify-between p-4 bg-muted rounded-xl hover:bg-muted-foreground/10 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <span className="text-foreground">Viewing History</span>
              </div>
