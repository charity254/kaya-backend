...
import { Sprout, ArrowRight, Shield, ArrowLeft, Eye, EyeOff, Mail, Phone, Lock } from 'lucide-react';
...
export function FarmerAuth({ onAuthenticated, onBack }: FarmerAuthProps) {
  ...
  const handleVerifyOTP = (e: React.FormEvent) => {
    ...
    onAuthenticated(phoneNumber, true); // true = new user (needs onboarding)
  };
  ...
  const handleSignIn = (e: React.FormEvent) => {
    ...
    // Extract phone number if it's a phone, or use a dummy one if email
    const phone = loginIdentifier.includes('@') ? '712345678' : loginIdentifier;
    onAuthenticated(phone, false); // false = existing user (skip onboarding)
  };

  // Welcome screen to choose sign up or sign in
  if (mode === 'welcome') {
    return (
      <div className="min-h-screen bg-[#fafaf8] flex flex-col">
        ...
        <div className="bg-[#2d5f3f] text-white p-6 pb-12">
          ...
          <h1 className="text-xl font-bold text-center mb-2">Farmer Authentication</h1>
          <p className="text-white/80 text-sm text-center">Join the transparent supply chain</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 max-w-md mx-auto">
            <div className="text-center mb-8">
              <div className="bg-[#2d5f3f]/10 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                <Sprout className="w-10 h-10 text-[#2d5f3f]" />
              </div>
              <h2 className="font-bold text-xl text-gray-900 mb-2">Welcome, Farmer!</h2>
              <p className="text-sm text-gray-600">
                Start recording your harvests and build traceability
              </p>
            </div>
      ...
      return (
        <div className="min-h-screen bg-[#fafaf8] flex flex-col">
          <div className="bg-[#2d5f3f] text-white p-6 pb-12">
            ...
            <h1 className="text-xl font-bold text-center mb-2">Create Farmer Account</h1>
    ...
    return (
      <div className="min-h-screen bg-[#fafaf8] flex flex-col">
        <div className="bg-[#2d5f3f] text-white p-6 pb-12">
          ...
          <h1 className="text-xl font-bold text-center mb-2">Sign In as Farmer</h1>
          <p className="text-white/80 text-sm text-center">Access your farmer dashboard</p>
        </div>
